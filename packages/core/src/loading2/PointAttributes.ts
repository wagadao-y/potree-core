...
export const POINT_ATTRIBUTES: { [key: string]: PointAttribute } = {
  ...
  RGBA_PACKED: new PointAttribute(
    "COLOR_PACKED",
    PointAttributeTypes.DATA_TYPE_INT8,
    4,
  ),
  COLOR_PACKED: new PointAttribute(
    "COLOR_PACKED",
    PointAttributeTypes.DATA_TYPE_INT8,
    4,
  ),
  ...
  NORMAL_FLOATS: new PointAttribute(
    "NORMAL_FLOATS",
    PointAttributeTypes.DATA_TYPE_FLOAT,
    3,
  ),
  INTENSITY: new PointAttribute(
    "INTENSITY",
    PointAttributeTypes.DATA_TYPE_UINT16,
    1,
  ),
  CLASSIFICATION: new PointAttribute(
    "CLASSIFICATION",
  ...
  SOURCE_ID: new PointAttribute(
    "SOURCE_ID",
    PointAttributeTypes.DATA_TYPE_UINT16,
    1,
  ),
  INDICES: new PointAttribute(
    "INDICES",
